...
namespace JoystickControls
{
    ...
    public class SimpleJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
    {
        ...
        private void OnEnable()
        {
            ...
            JoystickInputManager.RegisterVirtualAxis(HorizintalAxis);
            JoystickInputManager.RegisterVirtualAxis(VerticalAxis);
        }
        ...
        private void OnDisable()
        {
            ...
            JoystickInputManager.UnregisterVirtualAxis(HorizintalAxis);
            JoystickInputManager.UnregisterVirtualAxis(VerticalAxis);
        }
